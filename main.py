...
from handlers.user_handlers import start, ask_question, send_cv, my_id, callback_handler  # Import callback_handler from user_handlers
...
def create_application():
    ...
    # Remove the duplicate callback handler registration
